...
:::warning[ATENÇÃO!]
Muita coisa nas outras partes da mentoria será feita via linha de comando, e vão assumir que você sabe utilizar mesmo que de forma bem básica a linha de comando.
