...
![Animação demostrando a troca entre os modos claro e escuro desta página](img/01-modo-claro-escuro.gif "Animação demostrando a troca entre os modos claro e escuro desta página")
...
Por fim, [**Python**](https://www.python.org/) ([Wikipedia](https://pt.wikipedia.org/wiki/Python)) - pronunciado "Páiton". Esta é uma linguagem que começou sua vida no ambiente das universidades e foi criada para ajudar as pessoas a aprenderem a programar. Com o tempo, ela começou a ser adotada por programadores em diferentes áreas e foi evoluindo e amadurecendo com isso. _E o nome vem do grupo de comédia Monty Python, não da espécie de cobra com o mesmo nome._
...
- **Python:** Linguagem versátil e "tem em todo lugar", com uma poderosíssima seleção de ferramentas para se fazer de robôs a controlar máquinas industriais.
