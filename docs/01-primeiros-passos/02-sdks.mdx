...
<LangTabs>
  <kotlin>
    ...
    <OSTabs hidden>
      ...
      <mac>
        ...
        ![Instalação de uma JDK utilizando o SDKMAN! no Mac](img/02-mac-sdkman.gif "Instalação de uma JDK utilizando o SDKMAN! no Mac")
      </mac>
    </OSTabs>
    ...
    <OSTabs hidden>
      ...
      <mac>![Executando os comandos java -version e javac -version no Linux](img/02-mac-java-version.gif "Executando os comandos java -version e javac -version no Linux")</mac>
    </OSTabs>
  </kotlin>
  <java>
    Vamos instalar um conjunto de programas chamado **JDK - Java Development Kit**, em português: Kit para Desenvolvimento em Java.
  ...
  <js>
    ...
    <OSTabs hidden>
      ...
      <mac>![Executando os comandos node -v e npm -v no Linux](img/02-mac-js-version.gif "Executando os comandos node -v e npm -v no Linux")</mac>
    </OSTabs>
  </js>
  <python>
    Tudo que precisamos para programar em Python é o que ironicamente se chama simplesmente de [**Python**](https://www.python.org/). Veremos a seguir como instalar ele.
    ...
    <OSTabs hidden>
      ...
      <mac>
        ...
        1. Na [página de download](https://www.python.org/downloads/) do Python, clique no botão **Download Python** na área azul (parte superior do site, botão amarelo).
        2. Depois, basta instalar como qualquer programa: Abra o arquivo baixado e siga as instruções do instalador:\
           ![Instalando o Python 3 no Mac](img/02-mac-python-install.gif "Instalando o Python 3 no Mac")
      </mac>
    </OSTabs>

    <h3>b) Verificando se tudo instalou corretamente</h3>

    Para testar se tudo foi instalado corretamente, execute o comando `python --version` ou `python3 --version` se o anterior não existir. Se a saída for semelhante a esta abaixo, pronto!

    <OSTabs hidden>
      <windows>![Executando os comandos python3 --version e python --version no PowerShell](img/02-windows-python-version.gif "Executando os comandos python3 --version e python --version no PowerShell")</windows>
      ...
      <mac>![Executando o comando python3 --version no Mac](img/02-mac-python-version.gif "Executando o comando python3 --version no Mac")</mac>
    </OSTabs>
  </python>
</LangTabs>
