...
<LangTabs>
  ...
  <python>
    ...
    <OSTabs hidden>
      <windows>![Executando o comando python3 --version no PowerShell](img/02-windows-python-version.gif "Executando o comando python3 --version no PowerShell")</windows>
