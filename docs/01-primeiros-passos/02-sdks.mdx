  ...
  <python>
    ...
    <OSTabs hidden>
      <windows>
        ...
        2. Depois, basta instalar como qualquer programa: Abra o arquivo baixado e siga as instruções do instalador.\
           **:warning: Importante :warning: Durante a instalação, selecione a opção "Adicionar Python ao PATH". Isso fará com que o Python possa ser acessado pela linha de comando:**\
           
      </windows>
      <linux>
        No Linux, é recomendado que o Python seja instalado através de um gerenciador de pacotes.
    ...
    <OSTabs hidden>
      <windows>![Executando os comandos node -v e npm -v no PowerShell](img/02-windows-js-version.gif "Executando os comandos node -v e npm -v no PowerShell")</windows>
      <linux>![Executando os comandos node -v e npm -v no Linux](img/02-linux-python-version.gif "Executando o comando python3 --version no Linux")</linux>
